...
##
testPredRVmonitor(examplePropPath+'/InputProp1.xml',  examplePropPath+'/PropVerify1.xml',  [('a',10.9),('b',9),('b',13),('c',30)])           
print "#####################################################################"
print "#####################################################################"
...
##Input property: "InputPropUni.xml". Input property accepts all timed words over alphabet {a,b,c}. ####
##Property to verify: "PropVerify2.xml". Safety property expressing "there should be at least 5 t.u delay between any two b actions". 
